...
export const MenuItemStock = lazy(() => import('./MenuItemStock'))
export const MenuItemStockManagement = lazy(() => import('./MenuItemStockManagement'))
...
export const VendorLedger = lazy(() => import('./inventory/VendorLedger'))
